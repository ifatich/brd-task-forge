      ...
      <div className="w-full max-w-md rounded-[24px] border border-zinc-200 bg-white mx-4 overflow-hidden">
        ...
        <div className="p-5 space-y-5">
          ...
          <p className="text-xs text-zinc-500 ">
            Export tasks from <span className="font-medium text-zinc-700 ">{projectName}</span>
          </p>
                ...
                <button
                  ...
                  className={`rounded-lg border p-3 text-left transition-all ${
                    format === opt.value
                      ...
                      : "border-zinc-200 hover:border-zinc-300 :border-zinc-700"
                  }`}
                >
                  <div className="flex items-center gap-2 mb-1">
                    {opt.icon === "csv" ? (
                      ...
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-red-600 ">
                        <path d="M14.5 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V7.5L14.5 2z" />
                        <polyline points="14 2 14 8 20 8" />
                      </svg>
                    )}
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-lg border border-zinc-200 bg-white px-3 py-2 text-sm text-zinc-700 focus:outline-none focus:ring-2 focus:ring-zinc-900 :ring-white"
            >
          ...
          <div className="flex items-center gap-3 pt-1">
            <button
              ...
              className="flex-1 inline-flex items-center justify-center gap-2 rounded-lg bg-zinc-900 px-4 py-2.5 text-sm font-medium text-white hover:bg-zinc-800 :bg-zinc-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              {isExporting ? (
                <>
